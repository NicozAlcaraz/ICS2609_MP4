...
<!DOCTYPE html>
<c:set var="error" value="${(empty error) ? 'An unspecified error has occurred, or you accessed this error page intentionally. In this case, welcome!' : error}" />
<html>
    <head>
...
@media (max-width: 908px) {
    ...
    <body>
        ...
        <main>
            <div class="box">
                <p>Wrong Captcha! Please try to log in again.</p>
                <a href="${pageContext.request.contextPath}/CaptchaServlet">
                    <button>Back</button>
                </a>
            </div>
        </main>
